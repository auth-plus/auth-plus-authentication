...
import { CreatingToken } from '../../core/driven/creating_token.driven'
import { InvalidatingToken } from '../../core/driven/invalidating_token.driven'
...
export class TokenRepository implements InvalidatingToken, CreatingToken {
  ...
  async invalidate(token: string): Promise<void> {
    logger.debug(
      { cacheKeyPattern: 'invalidate:*', action: 'set' },
